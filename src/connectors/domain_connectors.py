"""Prospect Research Agent - Domain-Specific Connectors."""
...
class SalesforceConnector:
    """Domain-specific connector for salesforce integration with Prospect Research Agent."""
...
class HubspotConnector:
    """Domain-specific connector for hubspot integration with Prospect Research Agent."""
...
class OutreachConnector:
    """Domain-specific connector for outreach integration with Prospect Research Agent."""
...
class ApolloConnector:
    """Domain-specific connector for apollo integration with Prospect Research Agent."""
...
class LinkedinSalesNavigatorConnector:
    """Domain-specific connector for linkedin sales navigator integration with Prospect Research Agent."""
