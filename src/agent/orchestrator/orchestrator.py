"""Prospect Research Agent — Agent Orchestrator (Plan → Research → Execute → Validate → Respond)."""
...
class AgentOrchestrator:
    """Orchestrates the Prospect Research Agent through a multi-step pipeline.
