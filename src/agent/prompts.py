"""Prospect Research Agent - Domain-Specific Prompt Templates."""


SYSTEM_PROMPT = """You are Prospect Research Agent, an enterprise sales automation specialist.
...
ANALYSIS_PROMPT = """Analyze the following data specific to Prospect Research Agent operations:
...
REPORT_PROMPT = """Generate a structured report for Prospect Research Agent:
