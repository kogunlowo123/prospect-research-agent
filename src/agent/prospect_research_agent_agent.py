"""Prospect Research Agent - Main Agent Implementation."""
...
class ProspectResearchAgentAgent:
    """
    ...
    def __init__(self):
        ...
        self.prospect_enabled = True
        self.research_enabled = True
        self.analytics_enabled = True
        self.automation_enabled = True
        self._tool_dispatch = {
            "research_company": self.tools.research_company,
            "identify_stakeholders": self.tools.identify_stakeholders,
            "track_buying_signals": self.tools.track_buying_signals,
            "analyze_competitors": self.tools.analyze_competitors,
            "generate_briefing": self.tools.generate_briefing,
        }
        logger.info(
            "agent_initialized",
            ...
            features=['prospect', 'research', 'analytics', 'automation'],
        )
    ...
    async def _maybe_execute_tools(self, message: str, context: str) -> list[dict]:
        ...
        tool_keywords = {
            ...
            "track_buying_signals": ['track', 'buying', 'signals'],
