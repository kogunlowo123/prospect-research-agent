"""Prospect Research Agent - FastAPI Application."""
...
app = FastAPI(
    ...
    description="Prospect research agent that compiles company profiles, identifies key decision-makers, tracks buying signals, analyzes competitive landscape, and generates pre-call briefings for sales reps.",
    version="1.0.0",
    docs_url="/docs",
    redoc_url="/redoc",
    lifespan=lifespan,
